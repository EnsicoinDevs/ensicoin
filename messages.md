...
`2plus2is4` correspond en fait à un ping, et `minus1thats3` à un pong. Ces deux messages ne possèdent aucun champ particulier. Il est recommandé d’envoyer un `2plus2is4` toutes les 42 secondes et de s’assurer que les autres nœuds y répondent correctement.
...
| 32         | target      | char[32]   | Le target utilisé pour calculer ce bloc.                           |
